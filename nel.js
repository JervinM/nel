...
class Client {
    ...
    loadGUI() {
        $('toggle-multibox').replaceWith(`
        <input onchange="localStorage.setItem('botNick', this.value);" id="botNick" maxlength="15" class="form-control" placeholder="Bot Name" value="nelbots | COM"></input>
